...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass backdrop-blur-lg border-b border-border/50">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button className="bg-cta text-cta-foreground hover:bg-cta/90 font-medium hover-glow">
              Get a Quote
            </Button>
          </div>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 flex flex-col gap-4 animate-fade-in glass-card p-4 rounded-lg">
            <Link
              to="/"
            ...
            <Link
              ...
              onClick={() => setIsMenuOpen(false)}
              className={`text-foreground hover:text-accent transition-colors ${
                isActive('/portfolio') ? 'text-accent font-bold' : ''
              }`}
            >
              Portfolio
            </Link>
            ...
            <Button className="bg-cta text-cta-foreground hover:bg-cta/90 font-medium w-full hover-glow">
              Get a Quote
            </Button>
          </div>
        )}
